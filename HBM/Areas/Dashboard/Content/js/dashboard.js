  ...
  $(function() {
    ...
    if ($("#traffic-chart").length) {
      ...
      gradientStrokeGreen.addColorStop(1, 'rgba(132, 217, 210, 1)');
        ...
        gradientStrokeYellow.addColorStop(0, 'rgba(251, 248, 44, 1)');
        gradientStrokeYellow.addColorStop(1, 'rgba(251, 248, 44, 1)');
        var gradientLegendYellow = 'linear-gradient(to right, rgba(246, 243, 33, 1), rgba(246, 230, 33, 1))';

        var gradientStrokeOrange = ctx.createLinearGradient(0, 0, 0, 250);
        gradientStrokeOrange.addColorStop(0, 'rgba(255, 140, 0, 1)');
        gradientStrokeBlue.addColorStop(1, 'rgba(255, 215, 0, 1)');
        var gradientLegendOrange = 'linear-gradient(to right, rgba(255, 165, 0, 1), rgba(255, 215, 0, 1))';

      var trafficChartData = {
          datasets: [{
              data: [15, 1000, 50, 40, 100],
              backgroundColor: [
                  gradientStrokeBlue,
                  gradientStrokeGreen,
                  gradientStrokeRed
